    ...
    try {
        ...
        if (fileSizeInMB > limit) {
            ...
            await conn.sendMessage(m.chat, {
                document: buff_vid,
                caption: `${tradutor.texto6[0]} ${title}\n${tradutor.texto6[1]} ${roundedFileSizeInMB} MB`,
                fileName: title + '.mp4',
                mimetype: 'video/mp4'
            }, {quoted: m});
            await conn.sendMessage(m.chat, {
                text: `${tradutor.texto6[2]} ${roundedFileSizeInMB} ${tradutor.texto6[3]} ${title}`,
                edit: key
            }, {quoted: m});
        } else {
            enviando = false;
            await conn.sendMessage(m.chat, {
                video: buff_vid,
                caption: `${tradutor.texto7[0]} ${title}\n${tradutor.texto7[1]} ${roundedFileSizeInMB} MB`,
                fileName: title + '.mp4',
                mimetype: 'video/mp4'
            }, {quoted: m});
