...
(function (_0x8d3321, _0x5019dd) {
    const _0x36e927 = _0x31ac, _0x211e28 = _0x8d3321();
    while (!![]) {
        try {
...
let handler = async (_0x55976e, {
    ...
    try {
        ...
        if (!_0x55976e[_0x2359c0(0x1bb)]) throw `${lenguajeGB['smsAvisoFG']()}𝙉𝙊 𝙎𝙀 𝙀𝙉𝘾𝙊𝙉𝙏𝙍𝙊́ 𝙇𝘼 𝙄𝙈𝘼𝙂𝙀𝙉 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍 𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝙀 𝘼 𝙐𝙉𝘼 𝙄𝙈𝘼𝙂𝙀𝙉 𝙐𝙎𝘼𝙉𝘿𝙊 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊\x20` + (_0x33d1e6 + _0x480711) + '*';
        ...
        async function _0x4d2c5f(_0x2e4ee1) {
            const _0x398c4c = _0x2359c0, _0x5e6130 = await _0x29cf90[_0x398c4c(0x1c9)](_0x2e4ee1),
        ...
        var {img: _0x35d6f3} = await _0x4d2c5f(_0x434471);
...
function _0x14c2() {
    const _0x1897e4 = ['AUTO', 'user', '8CJixwu', 'getHeight', 'getBufferAsync', 'w:profile:picture', `${lenguajeGB['smsAvisoEG']()}𝙎𝙀 𝘾𝘼𝙈𝘽𝙄𝙊 𝘾𝙊𝙉 𝙀𝙓𝙄𝙏𝙊 𝙇𝘼 𝙁𝙊𝙏𝙊 𝘿𝙀 𝙋𝙀𝙍𝙁𝙄𝙇 𝘿𝙀𝙇 𝘽𝙊𝙏`, 'picture', 'read', '1419731ZjYevm', 'MIME_JPEG', '82272azbcaw', '350agtQLJ', '279gQMikZ', 'mimetype', '188728rlRvtO', 'msg', 'jid', 'image', '1705364hxGRFM', '14905ZvBfug', '2578255zmHnCy', 'getWidth', 'reply', '1780230pdlTpE', 'download', 'quoted', 'query', '2810ZHRQDi', 'resize', `${lenguajeGB['smsAvisoEG']()}𝙉𝙊 𝙎𝙀 𝙀𝙉𝘾𝙊𝙉𝙏𝙍𝙊́ 𝙇𝘼 𝙄𝙈𝘼𝙂𝙀𝙉 𝙋𝙊𝙍 𝙁𝘼𝙑𝙊𝙍 𝙍𝙀𝙎𝙋𝙊𝙉𝘿𝙀 𝘼 𝙐𝙉𝘼 𝙄𝙈𝘼𝙂𝙀𝙉 𝙐𝙎𝘼𝙉𝘿𝙊 𝙀𝙇 𝘾𝙊𝙈𝘼𝙉𝘿𝙊`, 'rowner'];
    _0x14c2 = function () {
        return _0x1897e4;
    };
    return _0x14c2();
